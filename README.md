...
pyos-pytest1 is a project that (describe what it does here).
...
```bash
$ pip install pyos-pytest1
```

TODO: Add a brief example of how to use the package to this section

To use pyos-pytest1 in your code:

```python
>>> import pyos-pytest1
>>> pyos-pytest1.hello_world()
```

## Copyright

- Copyright © 2026 Mailys Guedon.
